...
Save_save_data_args::~Save_save_data_args() throw() {
}
...
Save_save_data_pargs::~Save_save_data_pargs() throw() {
}
...
Save_save_data_result::~Save_save_data_result() throw() {
}
...
Save_save_data_presult::~Save_save_data_presult() throw() {
}
...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > SaveProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< SaveIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< SaveIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new SaveProcessor(handler));
  return processor;
}
