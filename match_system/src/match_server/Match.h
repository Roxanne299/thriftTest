...
class MatchIf {
 public:
  ...
  virtual int32_t remove_user(const User& suer, const std::string& info) = 0;
};
...
class MatchIfSingletonFactory : virtual public MatchIfFactory {
 public:
  MatchIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<MatchIf>& iface) : iface_(iface) {}
  virtual ~MatchIfSingletonFactory() {}

  virtual MatchIf* getHandler(const ::apache::thrift::TConnectionInfo&) {
    return iface_.get();
  }
  virtual void releaseHandler(MatchIf* /* handler */) {}

 protected:
  ::apache::thrift::stdcxx::shared_ptr<MatchIf> iface_;
};
...
class MatchNull : virtual public MatchIf {
 public:
  ...
  int32_t remove_user(const User& /* suer */, const std::string& /* info */) {
    int32_t _return = 0;
    return _return;
  }
};
...
class Match_add_user_args {
 public:
  ...
  Match_add_user_args() : info() {
  }

  virtual ~Match_add_user_args() throw();
  User user;
  std::string info;
...
class Match_add_user_pargs {
 public:
  ...
  virtual ~Match_add_user_pargs() throw();
  const User* user;
...
class Match_add_user_result {
 public:
  ...
  Match_add_user_result(const Match_add_user_result&);
  Match_add_user_result& operator=(const Match_add_user_result&);
  Match_add_user_result() : success(0) {
  }

  virtual ~Match_add_user_result() throw();
  int32_t success;
...
class Match_add_user_presult {
 public:
  ...
  virtual ~Match_add_user_presult() throw();
  int32_t* success;
...
typedef struct _Match_remove_user_args__isset {
  _Match_remove_user_args__isset() : suer(false), info(false) {}
  bool suer :1;
  bool info :1;
...
class Match_remove_user_args {
 public:
  ...
  Match_remove_user_args() : info() {
  }

  virtual ~Match_remove_user_args() throw();
  User suer;
  std::string info;

  _Match_remove_user_args__isset __isset;

  void __set_suer(const User& val);
...
class Match_remove_user_pargs {
 public:
  ...
  virtual ~Match_remove_user_pargs() throw();
  const User* suer;
  const std::string* info;
...
class Match_remove_user_result {
 public:
  ...
  Match_remove_user_result(const Match_remove_user_result&);
  Match_remove_user_result& operator=(const Match_remove_user_result&);
  Match_remove_user_result() : success(0) {
  }

  virtual ~Match_remove_user_result() throw();
  int32_t success;
...
class Match_remove_user_presult {
 public:
  ...
  virtual ~Match_remove_user_presult() throw();
  int32_t* success;
...
class MatchClient : virtual public MatchIf {
 public:
  MatchClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  MatchClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
 ...
 public:
  ...
  int32_t remove_user(const User& suer, const std::string& info);
  void send_remove_user(const User& suer, const std::string& info);
...
class MatchProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  MatchProcessor(::apache::thrift::stdcxx::shared_ptr<MatchIf> iface) :
    iface_(iface) {
...
class MatchProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  MatchProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< MatchIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< MatchIfFactory > handlerFactory_;
};

class MatchMultiface : virtual public MatchIf {
 public:
  MatchMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<MatchIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~MatchMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<MatchIf> > ifaces_;
  MatchMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<MatchIf> iface) {
 ...
 public:
  ...
  int32_t remove_user(const User& suer, const std::string& info) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->remove_user(suer, info);
    }
    return ifaces_[i]->remove_user(suer, info);
  }
...
class MatchConcurrentClient : virtual public MatchIf {
 public:
  MatchConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  MatchConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
 ...
 public:
  ...
  int32_t remove_user(const User& suer, const std::string& info);
  int32_t send_remove_user(const User& suer, const std::string& info);
